...
namespace SWD.BBMS.Repositories.Migrations
{
    ...
    [Migration("20240719100533_Booking service entity")]
    partial class Bookingserviceentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a7a57f94-add3-4712-af72-4e5ec5f81e47",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "d2170197-6e4c-4951-95a7-6c9673a9679f",
                            Name = "Staff",
                            NormalizedName = "STAFF"
                        },
                        new
                        {
                            Id = "cbf9650c-bc9a-41a4-8548-cbffc221f22d",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "3d3a7e9d-5955-45a8-adb7-d0728a680b0d",
                            Name = "Customer",
            ...
            modelBuilder.Entity("SWD.BBMS.Repositories.Entities.BookingService", b =>
                {
                    b.Property<int>("BookingId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SWD.BBMS.Repositories.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "04cc08cc-2fb7-49b3-a5b0-1b6d952fb32a",
                            CreatedDate = new DateTime(2024, 7, 19, 10, 5, 33, 197, DateTimeKind.Utc).AddTicks(7401),
                            Email = "admin@bbms.com",
                            EmailConfirmed = false,
                            FullName = "System Admin",
                            LockoutEnabled = false,
                            ModifiedDate = new DateTime(2024, 7, 19, 10, 5, 33, 197, DateTimeKind.Utc).AddTicks(7408),
                            NormalizedUserName = "ADMIN@BBMS.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAECL1NWFNPHM+ytDbp/zyelm4g9qjBMh/bOdPOmGcYo4IxCY5+ilckc+DnMtFnzoaOg==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = false,
                            Role = "Admin",
                            SecurityStamp = "4127d60c-9d0a-4316-b087-837a88a5811e",
                            Status = 0,
            ...
            modelBuilder.Entity("SWD.BBMS.Repositories.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("SWD.BBMS.Repositories.Entities.Payment", "Payment")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("SWD.BBMS.Repositories.Entities.BookingService", b =>
                {
                    ...
                    b.HasOne("SWD.BBMS.Repositories.Entities.Service", "Service")
                        .WithMany("BookingServices")
